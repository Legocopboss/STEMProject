...
def adminUIDEF(root, uname=None):
    ...
    def makeTable(tf):
        ...
        for r in table:
            ...
            x += 1
            y = 1
        Button(list_frame, text="Back", bg="cyan", command=back).grid(row=x + 1, column=1)
    ...
    def editMerch():
        ...
        def addItem():
            ...
            Button(edit_frame, text="Submit", command=newItem, bg="cyan").grid(row=5, column=1)
        ...
        def removeItem():
            ...
            Button(edit_frame, text="Submit", bg="cyan", command=itemRem).grid(row=2, column=3)
        ...
        def editItemName():
            ...
            def newName():
                if printItemInfo(idVarrr.get(), 2) == 'Error':
                    ...
                    Button(edit_frame, text="Submit", bg="cyan", command=editname).grid(row=2, column=3)

            idVarrr = StringVar()
            Label(edit_frame, text="Item ID for name edit: ").grid(row=2, column=1)
            Entry(edit_frame, textvariable=idVarrr).grid(row=2, column=2)
            Button(edit_frame, text="Submit", bg="cyan", command=newName).grid(row=2, column=3)
        ...
        def editItemPrice():
            ...
            Label(edit_frame, text="Item ID for name edit: ").grid(row=2, column=1)
            Entry(edit_frame, textvariable=idVarrr).grid(row=2, column=2)
            Button(edit_frame, text="Submit", bg="cyan", command=test).grid(row=2, column=3)
